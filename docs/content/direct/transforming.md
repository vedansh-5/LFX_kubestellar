...
This document is for users of a release. Examples of using the latest release are in [the example scenarios document](https://github.com/kubestellar/kubestellar/blob/main/docs/content/direct/example-scenarios.md). This document adds information not conveyed in the examples.
